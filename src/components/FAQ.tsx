...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="section-padding bg-nature-green-50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg sm:text-xl text-nature-green-600 max-w-3xl mx-auto">
            Ответы на часто задаваемые вопросы о проживании и услугах
          </p>
        </div>
        ...
        <div className="mt-16 bg-nature-green-600 text-white rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="inline-flex items-center space-x-2 bg-white text-nature-green-600 px-6 py-3 rounded-xl hover:bg-gray-100 transition-colors duration-200 font-medium"
            >
              <span>📞</span>
              <span>Позвонить</span>
            </a>
