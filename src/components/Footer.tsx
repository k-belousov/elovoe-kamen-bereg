          ...
          <div className="border-t border-nature-green-700 pt-8 mt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex space-x-6 mb-4 md:mb-0">
                <a 
                  href="#" 
                  className="text-nature-green-300 hover:text-white transition-colors transform hover:scale-110 duration-200"
              ...
              <div className="text-nature-green-300 text-sm">
                © 2024 База отдыха "Каменный берег". Все права защищены.
              </div>
            </div>
          </div>
        </div>
