      ...
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              onClick={onBook}
              className="flex-1 bg-nature-green-600 hover:bg-nature-green-700 text-white font-medium py-3 rounded-xl"
            >
              Забронировать номер
            </Button>
            <Button
              onClick={onClose}
              variant="outline"
              className="flex-1 border-nature-green-300 text-nature-green-700 hover:bg-nature-green-50 font-medium py-3 rounded-xl"
            >
              Закрыть
            </Button>
          </div>
