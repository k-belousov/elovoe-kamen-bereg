...
const InstagramIcon = () => <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="bg-nature-green-50 rounded-2xl p-8 h-full flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <BookingForm trigger={<Button className="bg-nature-green-600 hover:bg-nature-green-700 text-white font-semibold px-6 py-2">
                        Забронировать
                      </Button>} />
                </div>
                  ...
                  <div className="bg-white rounded-xl p-6 border border-nature-green-200">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-center">
                        <div className="w-2 h-2 bg-nature-green-600 rounded-full mr-3"></div>
