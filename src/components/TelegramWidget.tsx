...
const TelegramWidget = () => {
  ...
  return (
    <section id="news" className="section-padding bg-white px-4 sm:px-6 lg:px-8" data-section="telegram">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Виджет */}
        <div className="bg-nature-green-50 rounded-2xl p-4 sm:p-8">
          ...
          <div id="telegram-widget-container" className="max-w-2xl mx-auto min-h-[200px] flex items-center justify-center">
